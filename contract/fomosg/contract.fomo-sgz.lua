...
function Buy(arg_country, arg_num)
    ...
    if public_data.winner ~= nil and chainhelper:time() > public_data.timestamp then
        ...
        win_country.price = win_country.price +
                                math.floor(
                                    public_data.win_country_amount /
    ...
    chainhelper:log('Into the winner medal pool' ..
                        (win_country_amount / 100000))
    ...
    public_data.win_country_amount = public_data.win_country_amount +
                                         win_country_amount
    _save_data()
end
